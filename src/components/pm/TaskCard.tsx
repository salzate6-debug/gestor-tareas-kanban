...
import { Trash2, Calendar, MessageSquare, GripVertical } from "lucide-react";
...
export default function TaskCard({ task, index, columnId, onDelete, onOpen }: Props) {
        ...
        >
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              {(task.dueDate || task.comments.length > 0) && (
